...
public class PrincipalEmpresaValidator implements IValidator{
	...
	public void validate(Messages errors) throws Exception {
		if (!Is.emptyString(this.getModelo()) && (this.getEmpresa() != null)){
			if (this.getPrincipal()){
				String sql = " from " + this.getModelo() + " where principal = :principal and empresa.id = :empresa";
				...
				if (!results.isEmpty()){
					errors.add("Solo puede existir un principal por empresa"); 
				}
			}
		}
		else{
