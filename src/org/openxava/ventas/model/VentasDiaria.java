...
@View(members="empresa, fecha; importeNeto1, importeNeto2;" + 
		"ventas;")
...
public class VentasDiaria {
	...
	@ListProperties("numero, tipo, tipoOperacion, cliente.codigo, cliente.nombre, subtotalCtaCte1, subtotalCtaCte2, totalCtaCte1, totalCtaCte2")
	@OrderBy("fechaCreacion desc")
	public Collection<VentaElectronica> getVentas() {
		return null;
	}	
}
