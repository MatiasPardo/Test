...
public class ItemDesguace extends ItemTransaccion implements IItemMovimientoInventario{
	...
	public void setDesguace(Desguace desguace) {
	...
	public Deposito getDeposito() {
		if (this.getDesguace() != null){
			return this.getDesguace().getDepositoPartes();
		}
		else{
			return null;
		}
	...
	public void recalcular() {
		...
		if (this.getDesguace() != null){
			ListaPrecio listaCostos = this.getDesguace().getListaCostos();
			if ((listaCostos != null) && (this.getProducto() != null)){
				...
				BigDecimal cotizacion = this.getDesguace().buscarCotizacionTrConRespectoA(this.getDesguace().getMoneda2());				
