...
public class ReportSaldoFechaCtaCteVentasAction extends ReportBaseAction{

	private Date fecha;
	
	@Override
	public void execute() throws Exception {
		this.setFecha((Date)this.getView().getValue("fecha"));
	...
	protected String getNombreReporte() {
		return "SaldoCtaCteClienteFecha.jrxml";
	}
