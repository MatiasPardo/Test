...
public class OnChangeProveedorCompraAction extends OnChangePropertyBaseAction{
	...
	public void execute() throws Exception {
		if (!Is.emptyString((String)getNewValue())){
			...
			if (proveedor.getCondicionCompra() != null){
				Map<String, Object> values = new HashMap<String, Object>();
				values.put("id", proveedor.getCondicionCompra().getId());
				values.put("nombre", proveedor.getCondicionCompra().getNombre());
				getView().setValue("condicionCompra", values);
			} 
		}
	}
}
