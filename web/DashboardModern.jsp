...
<head>
	...
	<link rel="stylesheet" href="DashBoard/Style/material-dashboard.css?v=2.1.2" />
	...
	<link rel="stylesheet" href="DashBoard/Style/googleapi-fonts.css">
</head>
		
<%@ page import="org.openxava.dashboard.model.*" %>
		<%@ page import="java.util.*"%>
		<%@ page import="static java.lang.System.out" %>
<%
		DashBoard dashBoard= (DashBoard)session.getAttribute("clouderp_DashBoard");
		//session.setAttribute("name",dashboard);
...
//AGREGAR VALIDACION POR SI LA SERIE VIENE VACIA O EL BAR??
		...
		/**************************************/
		/*								
			out.println("	<div class=\"row sparkboxes col-lg-3 col-md-6 col-sm-6\">		");
			out.println("		<div class=\"card card-stats\">							");
			out.println("				<div class=\"card-header card-header-success card-header-icon\">				");
			out.println("					<div class=\"card-icon\">						");
			out.println("					<i class=\"material-icons\">store</i>				");
			out.println("					</div>												");
			out.println("					<p class=\"card-category\">Revenue</p>				");
			out.println("					<h3 class=\"card-title\">$34,245</h3>				");
			out.println("				</div>														");
			out.println("				<div class=\"card-footer\">									");
			out.println("					<div class=\"stats\">									");
			out.println("						<i class=\"material-icons\">date_range</i> Last 24 Hours				");
			out.println("					</div>				");
			out.println("				</div>				");
			out.println("		</div>				");
		*/
			...
			<%	int a = 1;
				...
				for(DataDashBoard dashboard: row.getGraphics()){
						if(dashboard.getType().equals(TypeDataDashBoard.Spark)){
							...
							out.println("	<div class=\"row sparkboxes col-lg-4 col-md-6 col-sm-1 offset-sm-0\">		");
							out.println("		<div class=\"card card-stats\">							");
							out.println("				<div class=\"card-header card-header-success card-header-icon\">				");
							out.println("					<div class=\"card-icon\">						");
							out.println("					<i class=\"material-icons\">"+dashboard.getIcon()+"</i>				");
							out.println("					</div>												");
							out.println("					<p class=\"card-category\">"+dashboard.getNombre()+"</p>				");
							out.println("					<h3 class=\"card-title\">"+dashboard.getValue()+"</h3>				");
							out.println("				</div>														");
							out.println("				<div class=\"card-footer\">									");
							out.println("					<div class=\"stats\">									");
							out.println("						<i class=\"material-icons\">date_range</i>"+dashboard.getDescription()+" ");
							out.println("					</div>				");
							out.println("				</div>				");
							out.println("		</div>				");
						}
